...
const MyCourses = () => {
  return (
    <div className="bg-gray-50 dark:bg-indigo-900 dark:text-white shadow-md p-2 rounded-3xl w-fit  lg:w-4/5 ">
      ...
      <ul className="flex p-2 rounded-xl text-xm text-gray-500  mx-5 dark:bg-indigo-950 dark:text-white  bg-gray-100 gap-24 justify-start">
        ...
        <li> نام دوره</li>
        <li className="w-[50px] hidden">مدرس</li>
      ...
      <div className="mt-4 mx-5 space-y-4">
        {coursesData.map((course, index) => (
          ...
          >
            ...
            <p className="  dark:text-white hidden text-[11px] lg:inline-flex  font-bold items-center w-[125px]  ">
              {course.teacher}
            </p>
            <span
            ...
            <span className="px-2 py-0 text-base  hidden bg-[#FF37F5] text-white rounded-full">
              {course.tag2}
            </span>
