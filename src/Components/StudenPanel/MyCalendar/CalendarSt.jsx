...
import { useSchedualAdmin } from "../../../core/services/api/CalendarSt/SchedualAdmin";

const CalendarSt = ({ handleAddEventSidebar, setEventStart }) => {
  ...
  const calendarOptions = {
    ...
    //   sidebarToggle: {
    //     text:
    //     <Menu className="d-xl-none d-block" />,
    //     click() {
