...
const index = () => {
  return (
    <div className="bg-gray-50 dark:bg-indigo-900  p-2 rounded-3xl   flex-1">
      <ul className="flex p-2 rounded-xl text-sm text-gray-500  m-5   bg-gray-100 gap-40 justify-start">
        <li>#</li>
        <li> نام دوره</li>
