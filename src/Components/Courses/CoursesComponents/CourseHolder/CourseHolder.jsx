...
const CourseHolder = () => {
  return (
    <div className="bg-white text-black dark:text-white p-6 sm:p-8 md:p-10 lg:p-12 xl:p-16 mr-0 sm:mr-6 md:mr-10 lg:mr-14 text-center font-sans relative dark:bg-indigo-950">
      ...
      <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-500">
        جدید میتونه تو پیشرفتت کمک کنه
      </p>
    </div>
  );
};
