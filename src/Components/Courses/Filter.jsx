...
<path d="M17.5 17.5L22 22" stroke="#2F2F2F" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M20 11C20 6.02944 15.9706 2 11 2C6.02944 2 2 6.02944 2 11C2 15.9706 6.02944 20 11 20C15.9706 20 20 15.9706 20 11Z" stroke="#2F2F2F" stroke-width="1.5" stroke-linejoin="round"/>
</svg>
...
<path d="M18.5 10.9922V11.0012" stroke="#272727" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
          ...
          <input type="range" className="w-full bg-gray-400 border-gray-400" min="10000" max="1000000"  />
        </div>
        ...
        <div className="mb-4">
          <div className="flex flex-row gap-1">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M11 13H16M8 13H8.00898M13 17H8M16 17H15.991" stroke="#272727" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M18 2V4M6 2V4" stroke="#272727" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
...
<path d="M3 8H21" stroke="#272727" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>

          <label className="text-gray-700 mb-2 block dark:text-white">تاریخ برگزاری - اتمام</label>
          </div>
          <p className="text-sm text-gray-500 mt-3 bg-gray-200 pr-4 h-6 rounded-lg">۲۹ اردیبهشت ۱۴۰۳ - ۵ خرداد ۱۴۰۳</p>
        </div>
      </div>
