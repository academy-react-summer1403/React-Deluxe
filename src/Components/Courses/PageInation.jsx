...
const Pagination = () => {
  return (
    <div className="flex flex-col items-center mr-96 justify-center  bg-white px-4 py-3 sm:px-6 rounded-5xl ">
      <div className="flex flex-1 justify-between sm:hidden rounded-20 h-96">
        <a
          href="#"
