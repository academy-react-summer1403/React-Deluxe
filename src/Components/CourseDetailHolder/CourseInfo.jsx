...
const CourseInfo = () => {
  ...
  return (
    <>
      ...
      >
        {/* Right Section: Course Image */}
        <div className="flex justify-center order-last mt-10 lg:mt-0 lg:order-none lg:w-1/2 lg:h-[25rem] bg-slate-700 dark:bg-indigo-800 rounded-[1.8rem]">
          <img
            src="https://via.placeholder.com/150" // Replace with your course image URL
            alt="Course"
            className="rounded-lg shadow-md"
        ...
        <div className="flex flex-col flex-grow mt-4 lg:mr-6 lg:w-1/2">
          ...
          {/* 2nd Row: Course Info Section */}
          <div className="flex flex-wrap justify-between mb-4">
            <div className=" basis-full flex flex-wrap justify-between mb-4 rounded-3xl lg:rounded-none lg:rounded-r-3xl lg:basis-[44%] border lg:border-0 lg:border-t lg:border-r lg:border-b border-gray-400 dark:border-gray-700 overflow-hidden">
            ...
            <div className="basis-full flex flex-wrap justify-between mb-4 rounded-3xl lg:rounded-none lg:rounded-l-3xl lg:basis-[56%] border border-gray-400 dark:border-gray-700 overflow-hidden">
          ...
          {/* 5th Row: Action Buttons */}
          <div className="flex flex-row justify-between">
            <button className="bg-[#3772FF] dark:bg-indigo-800 text-white px-8 py-2 rounded-full mr-2 hidden lg:flex items-center">
              <FaBook className="mx-2" />
              رزرو دوره
            </button>
            <button className="bg-[#2f2f2f] dark:bg-indigo-800 text-white px-2 lg:px-8 lg:py-2 rounded-full mx-auto flex items-center">
              <PiShoppingBagOpen className="mx-0 size-5 lg:mx-2" />
              اضافه به لیست مورد علاقه
            </button>
            <div className="flex gap-3">
      ...
      <div className="fixed bottom-0 right-auto z-10 lg:hidden bg-white dark:bg-indigo-950 w-[393px] h-20 flex items-center justify-around">
