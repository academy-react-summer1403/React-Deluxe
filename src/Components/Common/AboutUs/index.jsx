...
const index = () => {
  return (
    <div className=" bg-white flex flex-col items-center py-8 px-4 dark:bg-[#041124]">
      ...
      <p className="text-center max-w-3xl mb-8 text-base md:text-lg mt-2 text-gray-600 dark:text-white">
        ما به‌عنوان یک تیم همراه، پس از تکمیل پروژه نیز در کنار شما هستیم و با
        ارائه پشتیبانی فنی و به‌روزرسانی‌های مستمر، تضمین می‌کنیم که وب‌سایت شما
        همیشه در اوج بماند.
      </p>
      ...
      <div className="flex flex-wrap justify-center gap-8 md:gap-12 lg:gap-16 mt-24">
        {teamMembers.map((member, index) => (
          <div
            key={index}
            className="team-card flex flex-col items-center border-2 border-gray-300 rounded-2xl w-56 h-80 hover:w-64 hover:h-80 dark:bg-[#041124] transition-all duration-300 animate-card"
          >
