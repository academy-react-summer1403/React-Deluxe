  ...
  return (
    <div className=" bg-white flex flex-col items-center py-8 px-4 dark:bg-indigo-950">
      <div className="relative mb-8">
        <div>
          <img src={ReactLogo} className=" md:w-32 " />
        </div>
      </div>
      ...
      <div className="flex flex-wrap justify-center gap-8 md:gap-12 lg:gap-16">
        {teamMembers.map((member, index) => (
          <div key={index} className="flex flex-col items-center border-2 border-gray-300 rounded-2xl w-56 h-80 hover:w-64 hover:h-80 dark:bg-indigo-950 transition-all duration-300 mt-20">
