      ...
      <div className="flex flex-col w-full md:w-1/2 justify-start items-center p-5 md:p-10 text-black">
        ...
        <div className="flex justify-between w-full max-w-md mb-4">
          ...
          >
            ...
            />
            <span className="mt-2 min-h-[30px]">تایید کد ارسال شده دو مرحله‌ای</span>
          </div>
        </div>
        ...
        {currentTab === "1" && (
          <div className="w-full max-w-xs sm:max-w-md lg:max-w-lg text-center mt-14">
            ...
            <p className="text-gray-600 text-sm text-right mt-3 w-full md:w-96">
              لطفا شماره همراه یا ایمیل و رمز عبور خود را برای ورود به حساب کاربری وارد کنید.
            </p>
            <label className="block mt-5 text-sm font-bold text-right text-gray-700">
              شماره همراه یا ایمیل
            </label>
            <input
              className="mt-4 rounded-3xl w-full bg-white text-black px-4 py-2 border border-gray-300"
              placeholder="شماره همراه یا ایمیل خود را وارد کنید"
            />
            <label className="block mt-2 text-sm font-bold text-right text-gray-700">
              رمزعبور
            </label>
            <input
              type="password"
            ...
            <div className="flex items-center mt-2 justify-between w-full">
              <div className="flex items-center">
                ...
                <label htmlFor="rememberMe" className="text-sm pr-1 font-bold text-black">
                  مرا به خاطر بسپار
                </label>
              </div>
              <a
            ...
            <div className="flex justify-center mt-4 w-full">
              <button
                type="button"
                className="w-28 md:w-[141px] text-sm border-solid border border-gray-300 text-blue-500 py-2 px-4 rounded-3xl h-10 font-bold"
              >
                صفحه اصلی
              </button>
            </div>
        ...
        {currentTab === "2" && (
          <div className="w-full max-w-xs sm:max-w-md lg:max-w-lg text-center mt-14">
            <h2 className="text-2xl font-bold text-right">تایید کد دو مرحله‌ای!</h2>
            <p className="text-gray-600 text-sm mt-3  text-right">
              کد دو مرحله‌ای به شماره همراه شما ارسال شد. لطفا کد را وارد کنید.
            </p>
            <label className="block mt-8 text-sm font-bold text-right text-gray-700">
              کد دو مرحله ای
            </label>
            <input
